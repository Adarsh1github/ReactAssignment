...
var GmailBox = React.createClass({
 ...
 gmailLogin: function()
 {
   ...
   var win         =   window.open(_url, "windowname1", 'width=800, height=600'); //opens in window
 ...
 allLabels: function()
 {
     ...
     $.ajax({
      url: 'https://www.googleapis.com/gmail/v1/users/me/labels?key={AIzaSyDOF6l3WdFPnw-glx0w6KEU8fRyWKUe9uo}',
      dataType: 'json',
      type: 'GET',
 ...
 render:function()
 {
   ...
   if(loadedData){
     leftPanel =  <Child1 allLabelsData={this.state.allLabelsData}/>
